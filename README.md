...
Sistem memakai **3 kelas** pada kolom `jenis`:
- `kata kerja`
- `kata benda`
- `kata sifat`

`kata keterangan` tidak lagi didukung. Baris CSV dengan jenis lain ditolak saat upload. Migrasi database: `supabase/remove_kata_keterangan.sql`. Setelah migrasi, **latih ulang** checkpoint model (label lama 4 kelas tidak kompatibel).
