...
function getTestingSupabaseClient() {
    if (!testingSupabaseClient && window.createKamusSupabaseClient) {
        testingSupabaseClient = window.createKamusSupabaseClient();
    }
...
function handleFile(file) {
    ...
    var verb = Math.floor(basePairs * 0.52);
    var noun = Math.floor(basePairs * 0.35);
    var adj = basePairs - verb - noun;
