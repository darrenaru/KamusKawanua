...
def test_mbert_model(
    *,
    ...
    # Secara fungsional testing untuk mBERT sama seperti IndoBERT:
    # load model dari trained_models/{model_name} lalu hitung metrik.
    # Endpoint berbeda agar frontend bisa memilih algoritma yang tepat.
